    ...
    return (
        <AppBar position="sticky" className={classes.appbar}>
            <Toolbar className={classes.toolbar}>
                ...
                {
                    !isIPad && (
                        <Link underline="none" target="_blank" href="https://lightningprotocol.finance/assets/projects/automatic-audit-hacken.pdf">
                            <Box className="hacken">
                                <Typography color="inherit">AUDITED BY</Typography>
                                <img src={require("../assets/img/hacken-green.png").default} alt="hacken" />
                            </Box>
                        </Link>
                    )
                }
                        ...
                        !isMobile && (
                            <>
                                <Link underline="none" target="_blank" href="https://dory-pilkunnussija.gitbook.io/automatic-whitepaper/">
                                    <Button
                                        startIcon={
                                            <img width={22} height={22} src="https://assets-global.website-files.com/600ead1452cf056d0e52dbed/602d1bc4dada8daade9e5dbe_gitbook-favicon.ico" alt="doc-icon" />
                                        }
                                        variant="contained"
                                        style={{
                                            color: "white",
                                ...
                                <Button
                                    variant="contained"
                                    startIcon={
                                        <img width={22} height={22} src={config.aumi.img} alt="Token" />
                                    }
                                    endIcon={
                                    ...
                                    aria-haspopup="true"
                                    aria-expanded={isOpenTokenMenu ? 'true' : undefined}
                                    onClick={handleClickTokenMenu}
                                    style={{ marginRight: 8 }}
                                    color="secondary"
                                >
                                    AUMI = ${prices["automatic-network"]}
                                </Button>
                                <Menu
                                    id="token-menu"
                                    anchorEl={tokenEl}
                                    open={isOpenTokenMenu}
                                ...
                                >
                                    <Link
                                        ...
                                        color="inherit"
                                        target="_blank"
                                        href="https://quickswap.exchange/#/swap?outputCurrency=0x3eB177A6693eC81d1E170136f8AD02fffBE172a7"
                                    >
                                        <MenuItem onClick={handleCloseTokenMenu}>
                                            <ListItemIcon>
                                ...
                                <Button
                                    variant="contained"
                                    startIcon={
                                        <img width={22} src="https://assets.coingecko.com/coins/images/4713/large/matic-token-icon.png?1624446912" alt="Net" />
                                    }
                                    onClick={swn}
                                    color="secondary"
                                >
